...
import com.ovais.quickcode.barcode_manger.BarcodeConfig
...
import com.ovais.quickcode.features.create.data.toValidFormat
    ...
    private fun getContentBasedOnType(
        ...
        return when (type) {
            ...
            is CodeType.GeoLocation -> {
                val lat = selectedContentMap[com.ovais.quickcode.utils.LATITUDE].orEmpty()
                val lng = selectedContentMap[com.ovais.quickcode.utils.LONGITUDE].orEmpty()
